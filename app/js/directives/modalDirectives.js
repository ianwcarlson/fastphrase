var modalDirectives = angular.module('modalDirectivesModule', []);


modalDirectives.directive('overlay', [
...
modalDirectives.factory('ToggleHelper', [
...
modalDirectives.directive('toggle', [
        "$rootScope", "ToggleHelper", function($rootScope, ToggleHelper) {
            return {
                restrict: "A",
...
modalDirectives.directive('toggleable', [
        "$rootScope", "ToggleHelper", function($rootScope, ToggleHelper) {
            return {
                restrict: "A",
                link: function(scope, elem, attrs) {
